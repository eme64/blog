...
And a `Arrays::mismatch` benchmark can be found [here](https://eme64.github.io/blog/2026/03/23/VectorAPI-control-flow.html).
...
The larger the array (`num_elements`), the clearer the performance win.
[There are some known issues for very short loops](https://bugs.openjdk.org/browse/JDK-8344085), we
hope to address that in a future JDK version.
